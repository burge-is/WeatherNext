/* adapted from https://codepen.io/tholman/pen/AvWXMr */

const WeatherLoader = ({ loadingText }) => (
  <div className="preloader" css="opacity: 1; ">
    <svg
      version="1.1"
      id="sun"
      ...
      xmlSpace="preserve"
      css="opacity: 1; margin-left: 0px; margin-top: 0px;"
    >
      <g>
        <path
          fill="none"
